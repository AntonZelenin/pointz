...
impl<'a, 'b> DrawModel<'a, 'b> for wgpu::RenderPass<'a>
    where
        'b: 'a,
{
    fn draw_mesh(&mut self, mesh: &'b Mesh, material: &'b Material, uniform_bind_group: &'b wgpu::BindGroup) {
        self.draw_mesh_instanced(mesh, material, 0..1, uniform_bind_group);
    }
